<div  class="max-w-[1024px] mx-auto bg-white px-6 py-4 rounded-lg shadow-lg shadow-black/20">
    ...
    <div class="h-auto sm:h-16 flex flex-row items-center justify-between my-4 gap-4">
      ...
      <div class="text-xl sm:text-2xl md:text-4xl font-black uppercase hidden sm:inline-block">Field Service Report</div>
    ...
    <div class="flex flex-col my-2">
      ...
      <div class="inline-block gap-6 order-1 sm:order-2">
        ...
        <span class="text-base font-bold">{{ $getRecord()->job_date_started->format("M d, Y")  ?? '-' }}</span> 
      </div>
    </div>
    ...
    <table class="w-full mx-4 my-2">
      ...
      <tr class="text-left">
        ...
        <tr>
          ...
          <td>
            <span class="text-base font-bold">{{ $getRecord()->pressure_cooler_water_in ?? '-'}}</span>
          </td>
          <td>
            <span class="text-base font-bold">{{ $getRecord()->pressure_condenser_water_in ?? '-'}}</span>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <span class="text-base font-bold">{{ $getRecord()->pressure_cooler_water_out ?? '-'}}</span>
          </td>
          <td>
            <span class="text-base font-bold">{{ $getRecord()->pressure_condenser_water_out ?? '-'}}</span>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <span class="text-base font-bold">{{ $getRecord()->water_pressure_drop_cooler ?? '-'}}</span>
          </td>
          <td>
            <span class="text-base font-bold">{{ $getRecord()->water_pressure_drop_condenser ?? '-'}}</span>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <span class="text-base font-bold">{{ $getRecord()->approach_condenser_cooler_temp ?? '-'}}</span>
          </td>
          <td>
            <span class="text-base font-bold">{{ $getRecord()->approach_condenser_condenser_temp ?? '-'}}</span>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <span class="text-base font-bold">{{ $getRecord()->approach_evaporator_cooler_temp ?? '-'}}</span>
          </td>
          <td>
            <span class="text-base font-bold">{{ $getRecord()->approach_evaporator_condenser_temp ?? '-'}}</span>
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <div class="flex flex-col max-h-min flex-wrap">
        <div class="inline-block gap-6 my-2 min-h-40">
          ...
          @if($personnels = $getRecord()->personnels)
              ...
              <span class="text-base font-bold text-nowrap">{{ $personnel->name }}</span>
              @if(!$loop->last),@endif
              @endforeach
          @else
              <span class="text-base font-bold">NA</span>
        ...
        <div class="inline-block">
          ...
          <span class="text-base font-bold">{{ $getRecord()->time_arrived->format("H:m A") ?? '-'  }}</span>
        </div>
        <div class="inline-block">
          <span class="text-xs uppercase">Date Completed:</span>
          <span class="text-base font-bold">{{ $getRecord()->time_arrived->format("M d, Y") ?? '-'  }}</span>
        </div>
        <div class="inline-block">
...
@endphp
        ...
        <div class="inline-block my-2 min-h-40">
          <span class="text-xs">1) How satisfied were you with our respond time for equipment breakdown when complain lodged? </span>
          <br>
          <div class="border-2 text-center">
                        <span class="text-base font-bold">{{ getSatisfactionText($getRecord()->response_time_rate ?? null)  }}</span>
        ...
        <hr>
        <div class="inline-block my-2 min-h-40">
          <span class="text-xs">2) How satisfied were you with our service experience and work attitude?</span>
          <br>
          <div class="border-2 text-center">
            <span class="text-base font-bold">{{ getSatisfactionText($getRecord()->service_time_rate ?? null)  }}</span>
          </div>
          <span class="text-xs">Comments:</span>
          <br>
        ...
        <hr>
        <div class="inline-block my-2 min-h-40">
          <span class="text-xs">3) How satisfied were you with how the support staff resolved your most recent problem?</span>
          <br>
          <div class="border-2 text-center">
            <span class="text-base font-bold">{{ getSatisfactionText($getRecord()->resolution_time_rate ?? null)  }}</span>
          </div>
          <span class="text-xs">Comments:</span>
          <br>
        ...
        <hr>
        <div class="inline-block my-2 min-h-40">
          <span class="text-xs">Do you have any suggestions for us to provide better service to you?</span>
          <br>
