<div class="w-full">
    ...
    <div class="max-w-full pb-4 px-6 mx-auto mb-20 min-h-screen">
        ...
        <div class="block w-full z-10 sticky top-0">
            <div id="top-space" class="w-full transition-all duration-300 min-h-0" 
            ...
            <div
                class="flex flex-col min-h-min bg-white py-4 px-4 border border-gray-300 rounded-lg w-full gap-4 relative">
                ...
                <button data-tooltip-target="tooltip-default" onclick="scrollToTop()"
                    class=" text-white rounded h-min absolute top-1 right-0 p-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        id="Arrow-Up-Large-2--Streamline-Sharp" height="20" width="20">
                        <desc>Arrow Up Large 2 Streamline Icon: https://streamlinehq.com</desc>
                        <g id="arrow-up-large-2--move-up-arrow-arrows-large-head">
                            <path id="Vector (Stroke)" fill="#2859c5" fill-rule="evenodd"
                                d="m22.5 3.938 -21 0 0 -3 21 0 0 3Z" clip-rule="evenodd" stroke-width="1"></path>
                            <path id="Union" fill="#8fbffa" fill-rule="evenodd"
                                d="m12 5.875 8.012 8.011v2.67h-5.508V23h-5v-6.443H3.989v-2.67l8.012 -8.012Z"
...
<script>
    ...
    const stickyDiv = document.getElementById('top-space');

    window.addEventListener('scroll', () => {
        if (window.pageYOffset > 0) {
            stickyDiv.style.minHeight = '100px';
        } else {
            stickyDiv.style.minHeight = '0';
        }
    });
